  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard title="Итоговая оценка" value={analysis.report.overallScore} color="text-sky-400" />
          <StatCard title="Вовлеченность" value={analysis.report.engagement} color="text-amber-400" />
          <StatCard title="Качество речи" value={analysis.report.speechQuality} color="text-teal-400" />
          <StatCard title="Эмоциональное разнообразие" value={analysis.report.emotionalVariance} color="text-violet-400" />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-slate-800/50 p-6 rounded-lg">
            <h3 className="text-xl font-bold mb-4 text-sky-400">Итоговая оценка и рекомендации</h3>
            <div className="space-y-4 text-slate-300">
                <div>
                    <h4 className="font-semibold text-slate-100">Эмоциональный фон</h4>
                    <p>{analysis.report.emotionalBackground}</p>
                </div>
                <div>
                    <h4 className="font-semibold text-slate-100">Структурированность и ясность</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <h4 className="font-semibold text-amber-400">Предложения по улучшениюt</h4>
                        <ul className="list-disc list-inside space-y-1 mt-1">
        ...
        <div className="space-y-6">
          <div className="bg-slate-800/50 p-6 rounded-lg">
            <h3 className="text-xl font-bold mb-4 text-sky-400">Эмоции</h3>
            <div className="h-48">
              <EmotionChart data={analysis.emotionData} />
            </div>
          </div>
          <div className="bg-slate-800/50 p-6 rounded-lg max-h-96 overflow-y-auto">
            <h3 className="text-xl font-bold mb-4 text-sky-400">Транскрипция</h3>
