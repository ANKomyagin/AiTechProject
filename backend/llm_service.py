...
{{
    "Эмоциональный фон": "строка (детальный анализ преобладающих эмоций и их влияния)",
    "Качество речи": "Отлично/Хорошо/Удовлетворительно/Плохо (оценка с учетом эмоциональной выразительности)",
    "Вовлеченность": "Высокая/Умеренная/Низкая (на основе эмоционального воздействия)",
    "Эмоциональное разнообразее": "Динамичный/Умеренное/Монотонный (анализ смены эмоций)",
    "Структура": "строка (как эмоции поддерживают структурное построение речи)",
    "Общая оценка": число 0-100 (с весомым учетом эмоционального компонента)",
    "Сильные стороны": ["сила1 (эмоциональная)", "сила2 (эмоциональная)"],
    "Рекомендации": ["совет1 по эмоциональной подаче", "совет2 по эмоциональной подаче"]
}}
"""
...
def _get_stub_report():
    return {
        "Эмоциональный фон": "Ошибка локальной нейросети.",
        "Качество речи": "Удовлетворительное",
        "Вовлеченность": "Низкая",
        "Эмоциональное разнообразие": "Умеренная",
        "Структура": "Не удалось сгенерировать.",
        "Общая оценка": 0,
        "Сильные стороны": ["Локальный запуск"],
        "Рекомендации": ["Убедитесь, что Ollama запущена"]
    }
